...
#[test]
fn test_find_typo() {
    let neko = NekoSearch::new().target("Python".to_string());
...
fn test_find_transposed_letters() {
    let neko = NekoSearch::new().target("martha".to_string());
...
fn test_find_common_prefix() {
    let neko = NekoSearch::new().target("Rustacean".to_string());
...
fn test_find_different_lengths() {
    let neko = NekoSearch::new().target("development".to_string());
